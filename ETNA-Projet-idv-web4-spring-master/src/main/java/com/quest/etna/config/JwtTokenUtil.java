...
//while creating the
// token - //1. Define claims of the token, like Issuer, Expiration, Subject,
// and the ID //2. Sign the JWT using the HS512 algorithm and secret key. //3.
...
private String doGenerateToken(Map<String, Object> claims, String subject) { 
	return Jwts .builder().setClaims(claims) .setSubject(subject) 
			...
			.signWith(SignatureAlgorithm.HS512, secret).compact(); } //validate token
